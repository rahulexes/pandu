...
export function calculateFinalScores(players) {
    ...
    scoredPlayers.sort((a, b) => {
        ...
        if (a.preAssignedRank !== undefined)
            return -1;
        if (b.preAssignedRank !== undefined)
            return 1;
    ...
    for (let i = 0; i < scoredPlayers.length; i++) {
        ...
        if (i > 0) {
            ...
            if (current.preAssignedRank !== undefined &&
                prev.preAssignedRank !== undefined &&
                current.preAssignedRank === prev.preAssignedRank) {
                // Same rank
            }
            else if (current.preAssignedRank === undefined &&
                prev.preAssignedRank === undefined &&
...
export function getRematchStartingPlayer(previousScores) {
    if (previousScores.length === 0)
        return '';
    const winner = previousScores.find(s => s.rank === 1) || previousScores[0];
    return winner.playerId;
}
//# sourceMappingURL=ScoringSystem.js.map