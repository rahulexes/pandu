 ...
 */
export declare enum SpecialActionPhase {
 ...
 */
export declare enum SpecialPowerType {
 ...
 */
export declare const VALID_TRANSITIONS: Record<GamePhase, GamePhase[]>;
//# sourceMappingURL=gameStates.d.ts.map